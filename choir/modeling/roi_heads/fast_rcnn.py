...
from choir.layers import Linear, ShapeSpec, batched_nms, cat, nonzero_tuple
from choir.modeling.box_regression import Box2BoxTransform
...
def fast_rcnn_inference_single_image(
    ...
    filter_mask = scores >= min(score_thresh, max(scores))  # R x K
...
class FastRCNNOutputLayers(nn.Module):
    ...
    def from_config(cls, cfg, input_shape):
        return {
            ...
            "test_topk_per_image"   : cfg.MODEL.TRANSFORMER.QUERIES_PER_IMAGE,
